...
r0_ego.B2D_MAT = SEL
# FULL VAL14 (1,118 scenarios, K = 10 planners): the nuPlan target tensors, ego tensors, response matrix and
# scenario map are the 1,118-scene files; every frozen call site reads these r0_ego attributes at call time.
r0_ego.NUPLAN_NPZ = '/data2/jeongtae/nuplan_full_val14/nuplan_val14_1118_relgraph_v2.npz'
r0_ego.NUPLAN_EGO = {'routed': '/data2/jeongtae/nuplan_full_val14/val14_1118_tensors.npz', 'logged': '/data2/jeongtae/nuplan_full_val14/val14_1118_ego_logged.npz'}
r0_ego.NUPLAN_K11 = '/data2/jeongtae/nuplan_full_val14/nuplan_val14_k10_1118_response_matrix.csv'
r0_ego.NUPLAN_META = '/data2/jeongtae/nuplan_full_val14/val14_1118_scenario_log_map.csv'
print('[chdrop_nolane_full] nuPlan target = FULL val14:', r0_ego.NUPLAN_NPZ, flush=True)
...
print(f'[chdrop_nolane_full] r2_graph {_r2.__file__} | r0_ego {r0_ego.__file__} | labels {SEL} | '
